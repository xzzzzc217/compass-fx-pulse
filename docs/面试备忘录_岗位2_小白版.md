...
| **TimeXer 时序预测**（兑现简历"MAE -17%"主张） | **第 8 章（新）** |
| **现场 demo 完整指南**（怎么演 + 兜底 + 时长） | **第 9 章（新）** |
| **常被刁难的问题** + 话术 | 第 10 章 |
| **不要犯的 5 个错误** | 第 11 章 |
| **面试前 1 小时复盘** | 第 12 章 |
| **代码位置 cheatsheet** | 第 13 章 |
| **术语速查表** | 第 14 章 |
